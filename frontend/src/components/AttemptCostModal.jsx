    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '24px 24px 16px', textAlign: 'center' }}>
          ...
          <p style={{ margin: '4px 0 0', fontSize: 12, color: 'var(--text-muted)' }}>{gameName}</p>
        </div>
        ...
        <div style={{ padding: '0 24px 24px' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: 'var(--text-muted)', fontWeight: 600 }}>💰 Wallet</span>
          ...
          {canAfford ? (
            <>
              <p style={{
                margin: '0 0 16px', fontSize: 12.5, color: 'var(--text-muted)',
